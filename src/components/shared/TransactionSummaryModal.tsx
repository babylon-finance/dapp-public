import { Flex, Box, Button, EthAddress, Heading, Link, Modal, Card, Text, Image, Icon, Tooltip } from 'rimble-ui';
      ...
      <Modal isOpen={showModal}>
        <Card borderRadius={1} p={0}>
          <Flex
            ...
            pb={3}
          >
            <Image src="/logo2.png" aria-label="MetaMask extension icon" size="24px" />
            ...
            <Flex justifyContent={'space-between'} flexDirection={'column'}>
              ...
              >
                ...
                >
                  ...
                  <Flex alignItems={['center', 'flex-end']} flexDirection={['row', 'column']}>
...
const SummaryContainer = styled(Box)`
  min-width: 450px;
`;
export default React.memo(TransactionSummaryModal);
