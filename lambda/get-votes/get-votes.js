const { getVotesForStrategy } = require('../shared/queries.js');
const { verifyDomain } = require('../shared/Verify.js');

const FUNCTION_NAME = 'get-votes';
...
exports.handler = async function (event, context, callback) {
  ...
  try {
    ...
    const votesResponse = await getVotesForStrategy(address);
    const finalResponse = votesResponse ? votesResponse.data : {};
