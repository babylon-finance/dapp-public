...
module.exports = function (webpackEnv) {
  ...
  // NOTE: Right now we only produce them in DEV since prod is having OOM issues during build
  ...
  return {
        ...
        },
        {
          ...
          oneOf: [
            ...
            // The preset includes JSX, Flow, TypeScript, and some ESnext features.
            {
              ...
              include: paths.appSrc,
              use: [
                // Since we're still using Webpack v4 and we have a somewhat high number of expensive loaders we use
                // thread loader to distribute the compilation work across a pre-warmed worker pool so we don't
                // overrun our build timeout in Netlify
                {
    ...
    plugins: [
      !isEnvProduction && analyzeBundle && new BundleAnalyzerPlugin(),
